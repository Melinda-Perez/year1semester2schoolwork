...
/* To use part2.Toolbox.java, copy and paste this code into a file called part2.Toolbox.java
 ...
 * Only one instance of the part2.Toolbox class should be created.
...
public class Toolbox {
	 ...
	 * The values will be consumed by part2.Toolbox instances instead of prompting the user for input or querying a random number generator.
