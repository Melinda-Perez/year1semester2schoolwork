...
class QuizTest {
	...
	private Integer getScore() {
		try {
			...
			int score = Double.valueOf(fields[0]).intValue();
			int total = Double.valueOf(fields[1]).intValue();
			Double percent = Double.valueOf(fields[2]);
	...
	class TestAllRight {
		...
		void wroteFile() {
			...
			assertEquals(Integer.valueOf(10), getScore(), "should have marked correctly");
		}
	}
